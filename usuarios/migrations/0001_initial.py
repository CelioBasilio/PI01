    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresapk', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Aluno',
            fields=[
                ...
                ('telefone', models.CharField(max_length=15, null=True, verbose_name='Telefone')),
                ('email', models.EmailField(max_length=100, null=True, unique=True)),
                ('alunopk', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
